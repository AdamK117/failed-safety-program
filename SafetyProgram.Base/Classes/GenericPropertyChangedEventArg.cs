...
{
    /// <summary>
    /// Defines an EventArg that may be used for generic data. Used almost exclusively 
    /// for statically typed (i.e. not string based like INotifyPropertyChanged) events.
    /// </summary>
    ...
    public sealed class GenericPropertyChangedEventArg<TPropertyType> : EventArgs
    {
        ...
        public TPropertyType NewProperty { get; private set; }
    }
}
